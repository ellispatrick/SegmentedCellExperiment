...
We can then set the cell types of each cell by extract and clustering marker intensity information.
...
## Example 2 - Custom intensity and morphology column names
...
## Example 3 - Minimal example, cells only have spatial coordinates
